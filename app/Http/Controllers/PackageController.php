...
class PackageController extends Controller
{
    ...
    {
        $this->authorize('list', [Package::class, $request->input('propertyId'), $request->get('unitId', null), $request->get('residentId', null)]);
    ...
    {
        $this->authorize('store', [Package::class, $request->input('propertyId'), $request->get('unitId', null), $request->get('residentId', null)]);
