...
class EloquentExpenseRepository extends EloquentBaseRepository implements ExpenseRepository
{
    ...
    public function findBy(array $searchCriteria = [], $withTrashed = false)
    {
        ...
        if (isset($searchCriteria['endDate'])) {
            $queryBuilder = $queryBuilder->whereDate('expenseDate', '<=', Carbon::parse($searchCriteria['endDate']));
            unset($searchCriteria['endDate']);
        }

        if (isset($searchCriteria['startDate'])) {
            $queryBuilder = $queryBuilder->whereDate('expenseDate', '>=', Carbon::parse($searchCriteria['startDate']));
