<tr>
    <td class="email-body" width="570" cellpadding="0" cellspacing="0">
        <table class="email-body_inner" style=" border: 1px solid #e1e1e1;" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tbody>
                <tr>
                    <td align="center" height="100%" valign="top" width="100%" bgcolor="#ffffff" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 0 15px 20px;" class="mobile-padding">
                        <!--[if (gte mso 9)|(IE)]>
                        <table align="center" border="0" cellspacing="0" cellpadding="0" width="600">
                            <tr>
                                ...
                                <![endif]-->
                                    ...
                                    <tbody><tr>
                                        <td align="center" valign="top" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; font-family: Open Sans, Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div style="font-size:15px;line-height:25px;color: #505C6C;">
                                                                        <table>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                                                                    <img alt="OK" width="80" src="{{ asset('logo/right.png') }}">
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td height="30" &nbsp;=""></td>
                                                                        ...
                                                                        <table style="border:1px solid #DAE1E9; border-bottom: 0; border-radius: 10px 10px 0 0; width:100%;text-align:center;padding:16px; margin-top: 24px;">
                                                                            <tbody>
                                                                            <tr>
                                                                                <td style="color:#0269C8;font-weight:500;">
                                                                                    You can activate these features for your needs.
                                                                                </td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <p style="color:#0269C8;text-align: center;">
                                                                            How do I prepare my account for this upgrade?
                                                                        </p>
