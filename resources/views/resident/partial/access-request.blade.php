                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <table class="action" align="center" width="100%" cellpadding="0"
                                            cellspacing="0"
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;  padding: 0; text-align: center; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                                            <tr>
                                                <td align="center"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <table class="subcopy" width="100%" cellpadding="0"
                                                                    cellspacing="0"
                                                                    style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; solid #edeff2; ">
                                                                    <tr>
                                                                        <td
                                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                            <p
                                                                                style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 16px;">
                                                                                Lorem ipsum dolor sit amet consectetur
                                                                                adipisicing elit. Tempora officiis
                                                                                incidunt eos, dicta quo ullam assumenda
                                                                                in, quae, illo exercitationem deleniti
                                                                                quas praesentium aliquid harum sint cum
                                                                                explicabo quia saepe? Tempora officiis
                                                                                incidunt eos, dicta quo ullam assumenda
                                                                                in, quae, illo exercitationem deleniti
                                                                                quas praesentium aliquid harum sint cum
                                                                                explicabo quia saepe?Tempora officiis
                                        ...
                                        <table class="promotion" align="center" width="100%" cellpadding="0"
                                            cellspacing="0"
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #FFFFFF; border: 2px dashed #9BA2AB; margin: 0; margin-bottom: 25px; margin-top: 25px; padding: 24px; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                                            <tr>
                                                <td
                                                    style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                    <span
                                        ...
                                        <table class="subcopy" width="100%" cellpadding="0" cellspacing="0"
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;  margin-top: 25px; padding-top: 25px;">
                                            <tr>
                                                <td
                                                    style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                    <p
                                                        ...
                                                        this is a private service. If you have any qestion or need
                                                        assistance
                                                        this is a private service. If you have any qestion or need
                                                        assistance please contact</p>
                                                </td>
                                            </tr>
                                        </table>
                                        <table class="action" align="center" width="100%" cellpadding="0"
