...
Route::group(['prefix' => 'api/v1'], function () {
    Route::group(['middleware' => ['auth:api']], function () {
        ...
        Route::apiResource('staff-time-clock-device','StaffTimeClockDeviceController', ['except' => ['update']]);
        ...
        Route::post('inventory-item-transfer', 'InventoryItemController@transfer');
        ...
        Route::apiResource('equipment-maintenance-log', 'EquipmentMaintenanceLogController');
        ...
        Route::get('reporting-equipment-maintenance', 'Reporting\\EquipmentMaintenanceController@index');
        Route::get('reporting-equipment-maintenance-state', 'Reporting\\EquipmentMaintenanceController@equipmentMaintenanceState');
        ...
        Route::get('reporting-staff-time-clock', 'Reporting\\StaffTimeClockController@index');
        Route::get('reporting-stc-month-wise-attendance-count', 'Reporting\\StaffTimeClockController@getMonthWiseStaffAttendance');
        Route::get('reporting-stc-working-hours-wise-attendance-count', 'Reporting\\StaffTimeClockController@getWorkingHoursWiseStaffAttendance');
    });
    ...
    Route::post('webhook-attendance', 'WebhookStaffTimeClockController@store');
